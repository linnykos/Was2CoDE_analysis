...
load("~/kzlinlab/projects/subject-de/out/tati/Writeup1/Writeup1_de.RData")
...
plot1 <-  EnhancedVolcano::EnhancedVolcano(de_results_wilcoxon,
                                        ...
                                        pCutoff = pCutoff,
                                        FCcutoff = FCcutoff)
ggplot2::ggsave(filename = paste0("~/kzlinlab/projects/subject-de/git/subject-de/figures/tati/Writeup1/Writeup1_de-volcano_wilcoxon.png"),
...
plot1 <-  EnhancedVolcano::EnhancedVolcano(de_results_t,
                                           ...
                                           pCutoff = pCutoff,
                                           FCcutoff = FCcutoff)
ggplot2::ggsave(filename = paste0("~/kzlinlab/projects/subject-de/git/subject-de/figures/tati/Writeup1/Writeup1_de-volcano_t.png"),
                plot1, device = "png", width = 7, height = 7, units = "in")
