...
ggsave(filename = "~/kzlinlab/projects/subject-de/git/subject-de_tati/figures/tati/Writeup6/Writeup6_SEA-AD_eSVD_volcano_colored_by_GeneLists.png",
...
write.table(genes_above_threshold$Gene, "~/kzlinlab/projects/subject-de/git/subject-de_tati/figures/tati/Writeup6/genes_above_threshold_eSVD.csv",
