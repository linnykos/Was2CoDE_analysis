...
plot_combination <- function(comb) {
  ...
  # Check the number of intersecting genes
  print(length(intersect_genes))
  print(length(indices1))
  ...
  # Check for NA values
  print(sum(is.na(res$pvalue1)))
  print(sum(is.na(res$pvalue2)))
  ...
  # Save combined plots
  filename <- paste0("~/kzlinlab/projects/subject-de/git/subject-de_tati/figures/tati/Writeup7/Writeup7_ROSMAP_Comparison_", method1, "_to_", method2, ".png")
