...
load("~/kzlinlab/projects/subject-de/out/tati/Writeup4/Writeup4_SEA-AD_NEBULA.RData")
load("~/kzlinlab/projects/subject-de/out/tati/Writeup4/Writeup3_Katie_Pseudobulk-DEseq2.RData")
load("~/kzlinlab/projects/subject-de/out/tati/Writeup4/Writeup4_SEA-AD_eSVD.RData")
...
plot_combination <- function(comb) {
  ...
  # Save combined plots
  filename <- paste0("~/kzlinlab/projects/subject-de/git/subject-de_tati/figures/tati/Writeup4/Writeup4_SEA-AD_Comparison_", method1, "to_", method2, ".png")
