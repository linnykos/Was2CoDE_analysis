...
log2FoldChange <- eSVD_obj$teststat_vec
...
# Save the plot
ggsave(filename = "~/kzlinlab/projects/subject-de/git/subject-de_tati/figures/tati/Writeup2/Writeup2_Katie_eSVD_volcano_colored_by_GeneLists.png",
       plot0, device = "png", width = 7, height = 7, units = "in")

# genes above significance threshold
genes_above_threshold <- res[res$pvalue < pCutoff, ]
# Print and save the genes
print(genes_above_threshold$Gene)
write.table(genes_above_threshold$Gene, "~/kzlinlab/projects/subject-de/git/subject-de_tati/figures/tati/Writeup2/genes_above_threshold_eSVD.csv",
