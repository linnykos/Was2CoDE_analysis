...
ggplot2::ggsave(filename = "~/kzlinlab/projects/subject-de/git/subject-de_tati/figures/tati/Writeup3/Writeup3_Pseudobulk-DEseq2_volcano.png",
...
ggplot2::ggsave(filename = "~/kzlinlab/projects/subject-de/git/subject-de_tati/figures/tati/Writeup3/Writeup3_Pseudobulk-DEseq2_colored_by_GeneLists.png",
...
write.table(genes_above_threshold, "~/kzlinlab/projects/subject-de/git/subject-de_tati/figures/tati/Writeup3/genes_above_threshold_Pseudobulk-DEseq2.csv", 
