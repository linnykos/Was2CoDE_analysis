...
teststat_vec <- nebula_res$summary[,"logFC_Study_DesignationAD"]
...
plot1 <- enrichplot::dotplot(gse, showCategory=30) + ggplot2::ggtitle("dotplot for GSEA (Katie's NEBULA)")
plot1 <- plot1 + ggplot2::theme(axis.text.y = ggplot2::element_text(size = 8))

ggplot2::ggsave(filename = paste0("~/kzlinlab/projects/subject-de/git/subject-de_tati/figures/tati/Writeup5/Writeup5_prater_nebula-test.png"),
