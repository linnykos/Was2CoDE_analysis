...
seurat_obj <- Seurat::SCTransform(seurat_obj,
                                  vars.to.regress = c(categorical_vars,numerical_vars),
                                  verbose = FALSE)

options(Seurat.object.assay.version = "v5")
seurat_obj[["SCT"]] <- as(object = seurat_obj[["SCT"]], Class = "Assay5")
...
save(date_of_run, session_info, 
     seurat_obj,
     file = "~/kzlinlab/projects/subject-de/out/kevin/Writeup3/Writeup3_sea-ad_microglia_preprocess_SCTransform.RData")
