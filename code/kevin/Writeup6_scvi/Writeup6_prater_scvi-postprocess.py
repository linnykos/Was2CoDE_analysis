...
save_path = os.path.join(save_dir, "Writeup6_prater_scvi_Pt_ID.png")
...
save_path = os.path.join(save_dir, "Writeup6_prater_scvi_CognitiveStatus.png")
# Create the UMAP plot without displaying it
sc.pl.umap(
    adata2,
...
save_path = os.path.join(save_dir, "Writeup6_prater_scvi_SeqBatch.png")
# Create the UMAP plot without displaying it
sc.pl.umap(
    adata2,
    color=["SeqBatch"],
...
save_path = os.path.join(save_dir, "Writeup6_prater_scvi_SeuratClusters.png")
# Create the UMAP plot without displaying it
sc.pl.umap(
    adata2,
