...
load("~/kzlinlab/projects/subject-de/out/kevin/Writeup2/Writeup2_sea-ad_microglia_esvd.RData")
set.seed(10)
...
ggplot2::ggsave(filename = "~/kzlinlab/projects/subject-de/git/subject-de_kevin/figures/kevin/Writeup2/Writeup2_microglia-pvm_esvd_umap.png",
