...
set.seed(10)
library(Seurat)
source("/Users/kevinlin/Library/CloudStorage/Dropbox/Collaboration-and-People/tati/git/subject-de/code/kevin/Writeup13_rrf-simulation/simulation_power_generator.R")
...
age_vec <- rep(round(rnorm(num_indiv/2),2), times = 2)
gender_vec <- rep(c(0,0,0,1,1), times = 2)
tobacco_vec <- rep(sample(c(0,1), size = num_indiv/2, replace = TRUE), 
                   times = 2)
...
save(seurat_obj,
     ...
     file = "/Users/kevinlin/Library/CloudStorage/Dropbox/Collaboration-and-People/tati/out/kevin/Writeup13/Writeup13_simulation_data.RData")
