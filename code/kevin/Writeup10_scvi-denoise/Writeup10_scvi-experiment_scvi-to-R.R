...
df <- arrow::read_feather("/home/users/kzlin/kzlinlab/projects/subject-de/out/kevin/Writeup10/Writeup10_scvi-experiment.feather")
...
pdf("~/kzlinlab/projects/subject-de/git/subject-de_kevin/figures/kevin/Writeup10/Writeup10_scvi-experiment_umap-covariates.pdf",
