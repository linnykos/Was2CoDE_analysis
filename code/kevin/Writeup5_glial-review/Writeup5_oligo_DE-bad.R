...
plot1 <- EnhancedVolcano::EnhancedVolcano(de_markers,
                                          ...
                                          xlim = c(-1,1)*max(abs(de_markers$avg_log2FC)),
                                          x = "avg_log2FC",
                                          y = "p_val",
                                          pCutoff = pCutoff,
                                          FCcutoff = FCcutoff,
...
ggplot2::ggsave(filename = paste0("~/kzlinlab/projects/subject-de/git/subject-de_kevin/figures/kevin/Writeup5/Writeup5_oligo_DE-bad.png"),
...
ggplot2::ggsave(filename = paste0("~/kzlinlab/projects/subject-de/git/subject-de_kevin/figures/kevin/Writeup5/Writeup5_oligo_DE-bad_ylim.png"),
                plot1, device = "png", width = 7, height = 7, units = "in")
